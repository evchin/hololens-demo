...
{
	public enum Flavour { CLOUD = 1, OFFLINE = 2, FLAVOUR_UNKNOWN = 0 };
	public static class FlavourTraitsFacotry
	{
		static Dictionary<Flavour, FlavourTraits> flavourTraits = new Dictionary<Flavour, FlavourTraits>()
		{
			...
			},
			{
				...
				new FlavourTraits()
					{
						UpdateCheckMemo = "avatar_sdk_last_update_check_offline",
						UpdateCheckUrl = "https://releases.avatarsdk.com/unity-plugin/version_offline.txt",
						Version = new Version(2, 2, 0),
						Name = "Avatar SDK Offline"
					}
			}
		};
