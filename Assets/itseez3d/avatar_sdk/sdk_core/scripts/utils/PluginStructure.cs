...
namespace ItSeez3D.AvatarSdk.Core
{
	...
	public static class PluginStructure
	{
		...
		public static readonly string UMA_RESOURCES_DIR = "itseez3d/avatar_sdk_uma/offline/resources/bin";
		...
		private static Dictionary<SampleScene, string> scenesPaths = new Dictionary<SampleScene, string>()
		{
			...
			{ SampleScene.OFFLINE_06_CARTOONISH, "itseez3d/avatar_sdk/samples_offline/06_cartoonish_sample_offline/scenes/06_cartoonish_sample_offline.unity" },
