...
namespace ItSeez3D.AvatarSdk.Core
{
	...
	public class BodyShapeGroup : ComputationPropertiesGroup
	{
		...
		public ComputationProperty<float> chest = new ComputationProperty<float>("plus", "chest");
		public ComputationProperty<float> waist = new ComputationProperty<float>("plus", "waist");
		public ComputationProperty<float> hips = new ComputationProperty<float>("plus", "hips");
