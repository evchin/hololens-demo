...
namespace ItSeez3D.AvatarSdk.Core
{
	...
	public class MaterialAdjuster
	{
		...
		public static Material GetHeadMaterial(string avatarCode, Texture2D mainTexture, AvatarShaderType shaderType)
		{
			if (shaderType == AvatarShaderType.Standard)
			{
				...
				string roughnessMapFilename = AvatarSdkMgr.Storage().GetAvatarTextureFilename(avatarCode, "roughness_map");
				string metallicMapFilename = AvatarSdkMgr.Storage().GetAvatarTextureFilename(avatarCode, "metallic_map");
		...
		public static Material GetHaircutMaterial(Texture2D haircutTexture, string haircutName, AvatarShaderType shaderType)
		{
